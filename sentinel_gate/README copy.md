...
python c:\Temp\wezos-gates\sentinel_gate\interfaces\cli.py --source csv --config c:\Temp\wezos-gates\seu_config.json --output c:\Temp\wezos-gates\reports_test
